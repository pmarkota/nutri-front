    ...
    <div className="relative z-20">
      ...
      <motion.div className="relative mt-1" whileHover={{ scale: 1.01 }}>
        <button
          ...
          className={`w-full px-6 py-3 text-left bg-white rounded-xl
        ...
        <div className="relative py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="absolute inset-0 overflow-hidden opacity-50">
            <motion.div
              ...
              className="absolute -top-1/2 -right-1/2 w-full h-full bg-gradient-to-br from-emerald-100/20 to-cyan-100/20 rounded-full"
            />
            <motion.div
              animate={{
                rotate: [360, 0],
              ...
              className="absolute -bottom-1/2 -left-1/2 w-full h-full bg-gradient-to-tr from-blue-100/20 to-emerald-100/20 rounded-full"
            />
          </div>
          ...
          <div className="relative max-w-xl mx-auto">
            ...
            >
              ...
              <p className="mt-3 text-lg text-gray-600">
                Create your account and start your path to better health
              </p>
            </motion.div>
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <FormInput
                  ...
                  error={
                    formState.touched.caloricGoal &&
                    formState.errors.caloricGoal
                  }
